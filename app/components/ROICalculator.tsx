...
export default function ROICalculator() {
  ...
  return (
    <div className="card-static rounded-2xl p-8 max-w-2xl mx-auto">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full input-light rounded-xl pl-8 pr-4 py-3"
            />
          </div>
      ...
      {showResult && (
        <div className="bg-gradient-to-br from-accent-blue/5 to-accent-purple/5 border border-accent-blue/20 rounded-xl p-6 mb-6 animate-fade-in-up">
          <p className="text-accent-blue text-sm font-semibold uppercase tracking-wider mb-2">Your estimated monthly savings</p>
          <p className="text-5xl font-display font-bold text-neural-900 mb-2">
            ${monthlySavings.toLocaleString()}
          </p>
          <p className="text-neural-700 text-sm font-medium">
            That&apos;s <span className="font-bold gradient-text">${annualSavings.toLocaleString()} per year</span> you could save with automation.
          </p>
      ...
      {showResult && (
        <a
          href="#contact"
          className="block w-full text-center bg-gradient-to-r from-accent-blue to-accent-purple text-white py-4 rounded-xl font-semibold text-lg transition glow-pulse"
        >
      ...
      {!showResult && (
        <div className="text-center text-neural-400 text-sm py-4 border border-dashed border-neural-300 rounded-xl font-light">
